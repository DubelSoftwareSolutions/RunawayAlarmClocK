...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'high_level' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kdabek/ROSWorkspace/src/high_level/${idir}'.  ${_report}")
    endif()
...
set(high_level_EXPORTED_TARGETS "")
